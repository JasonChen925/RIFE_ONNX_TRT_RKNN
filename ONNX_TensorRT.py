...
onnx_model = onnx.load(r"/home/jason/RIFE_ONNX_TRT_RKNN/ECCV2022-RIFE/train_log_origin/IFNet_o_fp32.onnx")
...
### 保存引擎到文件
with open('train_log_origin/model_1440x2560_fp32.trt', mode='wb') as f:  #生成二进制文件
